...
type Variant = "destructive_outline" | "destructive" | "neutral" | "menu" | "destructive_menu" | "primary";
...
export default function Button({variant = "destructive_outline", children, className, ...props}: Props) {
    const classes: Record<Variant, string> = {
        ...
        "menu": "w-full px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 hover:cursor-pointer data-focus:bg-gray-100 data-focus:text-gray-900 data-focus:outline-hidden",
        "destructive_menu": "w-full px-4 py-2 text-sm text-red-500 hover:bg-gray-100 hover:cursor-pointer data-focus:bg-gray-100 data-focus:outline-hidden",
