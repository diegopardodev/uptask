...
export default function LinkButton({type = "primary", href, children, className}: Props) {
    const classes: Record<string, string> = {
        ...
        "outline": "bg-white border border-primary-500 text-primary-500 w-fit py-2 px-7 font-semibold rounded-md hover:border-primary-600 hover:text-primary-600 text-sm md:text-base h-fit block",
    };
